...
# Monitor for 40 seconds and stop evaluation
log_with_timestamp "Waiting for 40 seconds before stopping the evaluation..."

# Sleep for 40 seconds to run the evaluation for a set duration
sleep 80
#python3 egoPos.py
# After 40 seconds, call the cleanup function to stop CARLA and the evaluation
cleanup
